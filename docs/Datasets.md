...
Once your dataset is approved, you can upload (individually or batched) large audio files (mp3, wav) with a maximum size of 2 GB each file. To do so, click on the New Media button to add audio files. 
